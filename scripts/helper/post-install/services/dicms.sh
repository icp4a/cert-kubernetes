...
cp4baADSStatus()
{
  printHeaderMessage "CP4BA Service Status - Decision Intelligence Client Managed Software"
...
cp4baADSConsole()
{
  printHeaderMessage "DICMS - Decision Intelligence Client Managed Software Console"
