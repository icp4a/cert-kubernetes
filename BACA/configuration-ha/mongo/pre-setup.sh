...
current_templates_path="../../stable/ibm-dba-baca-prod/charts/mongo-ha/templates"
current_base_path="../../stable/ibm-dba-baca-prod/charts/mongo-ha"
...
CONFIG_REPLSET_VALUE="${CONFIG_REPLSET_PREFIX}/${CONFIG_SERVER_LIST_S}"
