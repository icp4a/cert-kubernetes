...
cp sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql.template sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql
sed -i s/\$base_db_name/"$base_db_name"/ sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql
sed -i s/\$base_db_user/"$base_db_user"/ sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql
echo
echo "Running upgrade script: sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql"
db2 -stvf sql/UpgradeBaseDB_20.0.3_to_21.0.1.sql