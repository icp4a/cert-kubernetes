...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.viewone.viewoneDeployment // ""' -`
...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.contentDesignerRepoAPI.cdraDeployment // ""' -`
if [ "$isInstalled" == "NotInstalled" ]; then
...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.contentDesignerService.cdsDeployment // ""' -`
if [ "$isInstalled" == "NotInstalled" ]; then
...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.contentProjectDeploymentService.cpdsDeployment // ""' -`
if [ "$isInstalled" == "NotInstalled" ]; then
...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.gitgatewayService.gitsvcDeployment // ""' -`
if [ "$isInstalled" == "NotInstalled" ]; then
...
isInstalled=`cat ${current_cr_details_location} | ${YQ_CMD} '.status.components.ca.caDeployment // ""' -`
if [ "$isInstalled" == "NotInstalled" ]; then
