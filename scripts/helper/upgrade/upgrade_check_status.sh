...
function show_cp4ba_upgrade_status() {
    ...
    if [[ ! ("$cp4ba_original_csv_ver_for_upgrade_script" == "$CP4BA_RELEASE_BASE_MAJOR_VERSION"*) ]]; then
        ...
        printf "\n"
        echo "${RED_TEXT}[IMPORTANT]${RESET_TEXT}: If you're upgrading to CP4BA 24.0.1-IF005, 25.0.0-IF001, or 25.0.0-IF002, the cp-console custom hostname from previous versions will be reverted to default values. Refer to this Known Issue ${GREEN_TEXT}https://www.ibm.com/mysupport/s/defect/aCIgJ0000005oaT/dt451967?language=en_US${RESET_TEXT}. This issue is fixed in 24.0.1-IF006 and 25.0.0-IF003."
