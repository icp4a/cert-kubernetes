...
cp sql/UpgradeBaseDB_1.4_to_1.5.sql.template sql/UpgradeBaseDB_1.4_to_1.5.sql
sed -i s/\$base_db_name/"$base_db_name"/ sql/UpgradeBaseDB_1.4_to_1.5.sql
sed -i s/\$base_db_user/"$base_db_user"/ sql/UpgradeBaseDB_1.4_to_1.5.sql
echo
echo "Running upgrade script: sql/UpgradeBaseDB_1.4_to_1.5.sql"
db2 -stvf sql/UpgradeBaseDB_1.4_to_1.5.sql