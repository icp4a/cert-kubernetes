...
cp sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql.template sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql
sed -i s/\$base_db_name/"$base_db_name"/g sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql
sed -i s/\$base_db_user/"$base_db_user"/g sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql
sed -i s/\$tenant_id/"$tenant_id"/g sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql
sed -i s/\$tenant_ontology/"$tenant_ontology"/g sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql
echo
echo "Running upgrade script: sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql"
db2 -stvf sql/UpdateTenantInfo_in_BaseDB_1.3_to_1.4.sql