...
# function for creating the dbrds sql statement file for BAW_INSTANCE1_DB for BAW
# DBACLD-163779
function create_bawaws1_db_db2rds_sql_file(){    
    dbname=$1
    dbuser=$2
    dbserver=$3
    dbschema=$4
...
# function for creating the db rds sql statement file for BAW_INSTANCE2_DB for AWS
# DBACLD-163779
function create_bawaws2_db_db2rds_sql_file(){
    dbname=$1
    dbuser=$2
    dbserver=$3
    dbschema=$4
