...
# DBACLD-209353 Function to check if webhook belongs to the operators namespace being cleaned
...
if [[ $CLEAN_CRDS == "true" ]]; then
	CP4BA_CRDS=(
	    ...
	    "wfruntimemcpservers.icp4a.ibm.com"
	    "connectivitypacks.icp4a.ibm.com"
	)
